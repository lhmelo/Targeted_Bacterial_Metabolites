...
mzxmlpath <- "~/Desktop/MetabolomicsProjects/Summer2016Bacteria/data/160624_QE_Cyano"
functionpath <- "~/Desktop/MetabolomicsProjects/RScripts"
outputpath <- "~/Desktop/MetabolomicsProjects/Summer2016Bacteria/results_untargeted_DCM"
